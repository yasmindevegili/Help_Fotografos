...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:450px;" id="mySidebar"><br>
  ...
  <br>
  <br>
    <a href="pag_perfis_fotografo.php"><i style='font-size:24px' class='fas'>&#xf104;</i></a>
...
<form action="edit_fotografo_process.php" method="post"> 
<p>Nome de Usuário</p>
  ...
  <p>Biografia</p>
  <input type="text" name="bio" placeholder="Descreva-se" required="" value="<?php print $_SESSION['bio'] ?>">
  <p>Cidade</p>
  <input type="city" name="cidade" placeholder="Digite sua cidade" required="" value="<?php print $_SESSION['cidade'] ?>">
  <p>Estado</p>
  <input type="city" name="estado" placeholder="Digite seu estado" required="" value="<?php print $_SESSION['estado'] ?>">
  <p>Telefone</p>
  <input type="tel" name="tel" placeholder="(xx) xxxxx-xxxx" required="" value="<?php print $_SESSION['tel'] ?>">
<input type='submit' value='Salvar Alterações' class='btn btn-primary' />
<a href='delete.php?nome_usuario=<?php print $_SESSION['nome_usuario']?>' class='btn btn-danger'>Apagar perfil</a>
