...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:450px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">    
    <a href="editar_fotografo.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-user fa-fw w3-margin-right"></i>EDITAR FOTO</a> 
  </div>
    <div class="loginbox">
<!-- HTML form to update record will be here -->
<!--we have our html form here where new record information can be updated-->
<form action="edit_foto_process.php" method="post"> 
  <p>Foto do Perfil</p>
  <input type="file" name="foto_perfil" placeholder="Selecione uma foto de perfil" required="" value="<?php basename( __FILE__ );?>">
